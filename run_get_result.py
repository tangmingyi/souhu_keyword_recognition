...
PostProcessTool.get_core_res("data/res/res_extract_keyword2test.txt","data/res/submission_output","data/res/all_core.txt")

#将emotion和core 结果合并。
PostProcessTool.merge_core_emotion_finally("data/res/all_core.txt","data/res/extract_key_word_output/from_test_data","data/res/emotion_output","data/res/result.txt")